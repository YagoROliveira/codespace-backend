    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: resource_schema_2.ResourceBookmark.name, schema: resource_schema_2.ResourceBookmarkSchema },
                { name: resource_schema_3.ResourceLike.name, schema: resource_schema_3.ResourceLikeSchema },
            ]),
        ],
