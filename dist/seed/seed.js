...
async function seed() {
    ...
    const jsLesson1 = new mongoose_1.Types.ObjectId();
    const jsLesson2 = new mongoose_1.Types.ObjectId();
    const jsLesson3 = new mongoose_1.Types.ObjectId();
    const jsLesson4 = new mongoose_1.Types.ObjectId();
    const jsLesson5 = new mongoose_1.Types.ObjectId();
    const jsLesson6 = new mongoose_1.Types.ObjectId();
    const reactLesson1 = new mongoose_1.Types.ObjectId();
    const reactLesson2 = new mongoose_1.Types.ObjectId();
    const reactLesson3 = new mongoose_1.Types.ObjectId();
    const reactLesson4 = new mongoose_1.Types.ObjectId();
    const nodeLesson1 = new mongoose_1.Types.ObjectId();
    const nodeLesson2 = new mongoose_1.Types.ObjectId();
    const nodeLesson3 = new mongoose_1.Types.ObjectId();
    const tsLesson1 = new mongoose_1.Types.ObjectId();
    const tsLesson2 = new mongoose_1.Types.ObjectId();
    const devopsLesson1 = new mongoose_1.Types.ObjectId();
    const devopsLesson2 = new mongoose_1.Types.ObjectId();
    const archLesson1 = new mongoose_1.Types.ObjectId();
    const archLesson2 = new mongoose_1.Types.ObjectId();
    ...
    const weekStart = new Date(challengeNow);
    weekStart.setDate(challengeNow.getDate() - challengeNow.getDay());
