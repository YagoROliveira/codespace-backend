...
var UsersController = function () {
    ...
    var _updateNotifications_decorators;
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.getMe = function (userId) {
        ...
        UsersController_1.prototype.updatePassword = function (userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.updatePassword(userId, dto)];
                        case 1:
                            _a.sent();
        ...
        UsersController_1.prototype.updateNotifications = function (userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.updateNotifications(userId, dto)];
                });
            });
        };
        UsersController_1.prototype.deleteAccount = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.deleteUser(userId)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { message: 'Conta excluída com sucesso' }];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _updateMe_decorators = [(0, common_1.Put)('me')];
        _updatePassword_decorators = [(0, common_1.Put)('me/password')];
        _updateNotifications_decorators = [(0, common_1.Put)('me/notifications')];
        ...
        __esDecorate(_classThis, null, _updateNotifications_decorators, { kind: "method", name: "updateNotifications", static: false, private: false, access: { has: function (obj) { return "updateNotifications" in obj; }, get: function (obj) { return obj.updateNotifications; } }, metadata: _metadata }, null, _instanceExtraInitializers);
