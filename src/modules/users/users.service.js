...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findByEmail = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel.findOne({ email: email.toLowerCase() }).select('+password').exec()];
                });
            });
        };
        UsersService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.hash(data.password, 12)];
                        case 1:
                            hashedPassword = _a.sent();
                            user = new this.userModel(__assign(__assign({}, data), { email: data.email.toLowerCase(), password: hashedPassword }));
        ...
        UsersService_1.prototype.updatePassword = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isValid, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.userModel.findById(id).select('+password').exec()];
                        case 1:
                            user = _b.sent();
                            if (!user)
                                throw new common_1.NotFoundException('Usuário não encontrado');
                        ...
                        case 2:
                            isValid = _b.sent();
                            if (!isValid)
                                throw new common_1.NotFoundException('Senha atual incorreta');
                            _a = user;
                            return [4 /*yield*/, bcrypt.hash(dto.newPassword, 12)];
                        case 3:
                            _a.password = _b.sent();
        ...
        UsersService_1.prototype.updateNotifications = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel
                                .findByIdAndUpdate(id, { $set: { notificationPreferences: dto } }, { new: true })
                                .exec()];
                        case 1:
                            user = _a.sent();
                            if (!user)
