...
var CreateSessionDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateSessionDto() {
                ...
                this.meetingUrl = (__runInitializers(this, _durationMinutes_extraInitializers), __runInitializers(this, _meetingUrl_initializers, void 0));
                this.topics = (__runInitializers(this, _meetingUrl_extraInitializers), __runInitializers(this, _topics_initializers, void 0));
        ...
        (function () {
            ...
            _durationMinutes_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)()];
            _meetingUrl_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _topics_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ each: true })];
            _type_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(['mentoring', 'code_review', 'mock_interview', 'pair_programming'])];
...
var UpdateSessionDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _durationMinutes_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)()];
            _status_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(['scheduled', 'in_progress', 'completed', 'cancelled'])];
            _meetingUrl_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _recordingUrl_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
